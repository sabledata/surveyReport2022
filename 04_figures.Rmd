...
```{r figure1, fig.cap='(ref:figure1)', out.width = "350px", fig.align="center", warning=FALSE, echo=FALSE, message=FALSE, error=FALSE}
...
```{r figure2, fig.cap='(ref:figure2)',  out.height = "200px",echo=FALSE, fig.align="center", warning=FALSE}
...
(ref:figure3) Start locations of survey sets (red markers) conducted in `r yr` for the stratified random survey areas S~1~ through S~5~.  Movement/deep-water autonomous camera locations (triangle symbols) are labelled in red font.
...
p<-  ggplot(maturity.Freq, aes(x=YEAR, y=as.factor(MATURITY_CODE), fill = frequency )) + 
   ...
   ggsave(paste(path, "/Sablefish_StRS_Maturity.png", sep=''), p,
...
knitr::opts_chunk$set(out.height = "\\textheight",  out.width = "\\textwidth")
      ...
      panLab(0.79,0.4,paste("StRS 2003-",yr,  sep=""), cex=1.4)  # -- Labels
       ...
       img <-    paste(basepath,'figures/figure12.png',sep="")   # -- retrieve png 
              knitr::include_graphics(img)
```
(ref:figure13) Average length of male and female Sablefish by year. Counts by sex are labelled on top of the plotted lines.

```{r figure13, fig.cap='(ref:figure13)',results='asis', out.width = "450px",out.height = "250px", fig.align="center"}
     ...
     plot(fdat$YEAR, fdat$AvL,pch=2, ylim=c(52,MxSeam+6),xlim=c(2003,yr+1), cex=1.3, 
          ylab="Average length (cm)", xlab="Year", cex.lab=1.3, cex.axis = 1.3,
          col=rgb(0, .518, .659, 0.5),xaxt="n")
     axis(1, seq(2003,yr,1), cex.axis=1.3)
